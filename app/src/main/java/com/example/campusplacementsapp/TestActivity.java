...
import com.example.campusplacementsapp.Model.Questions;
...
public class TestActivity extends AppCompatActivity {
    ...
    public void updateQuestion() {
        ...
        if (computerCount > 1) {
            ...
            final Questions question=new Questions("what is kb?","kilobyte","kilobit","kilobits","megabyte","kilobyte");
            ...
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    //Toast.makeText(getApplicationContext(), (CharSequence) question, Toast.LENGTH_SHORT).show();
